...
export function ProjectsView({ onModalOpen }: { onModalOpen?: (isOpen: boolean) => void }) {
  ...
  useEffect(() => {
    onModalOpen?.(selectedSegment !== null);
  }, [selectedSegment, onModalOpen]);
        ...
        <div className="flex-1 flex flex-col relative z-10 pt-24 px-8 pb-8">
          ...
          {selectedSegment && (
            <SegmentDetailModal
              ...
              projectType={selectedProjectData.type}
